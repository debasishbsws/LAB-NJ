...
public class CurrentAccount extends Acccount {
    ...
    // constructor
    public CurrentAccount(int accountNo, String accountHolderName, double balance, String type, double interestRate) {
    ...
    // methods calculateInterest and displayAccountDetails
